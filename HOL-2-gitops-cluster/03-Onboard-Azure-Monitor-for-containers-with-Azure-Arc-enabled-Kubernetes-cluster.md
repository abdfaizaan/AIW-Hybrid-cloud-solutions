...
3. On the Configure Container insights blade, click on the **Advanced settings (1)** drop down menu for the Log Analytics workspace select the **loganalyticsws-XXXXXX (2)** from the dropdown and click on **Configure (3)**.
