...
1. Once `microk8s status --wait-ready` command start to run, wait for `10-15 minutes` let it run before prceeding to the next command. After that click on **Ctrl+C** to terminate. 
